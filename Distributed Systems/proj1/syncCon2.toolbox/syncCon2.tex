...
\@pvspace{8.0pt}%
 ...
 {\p@rparen}}%
 \@x{\@s{20.74} {\p@variable} v \.{=} 0 ,\, prev\_value \.{=} 0 ,\, Q \.{=} \{
 \} ,\, prev\_mb\_count \.{=} 0 ,\, ctr \.{=} 1 {\p@semicolon}\@s{49.19}}%
\@y{%
 ``\ensuremath{prev\_mb\_count}'' keeps the track of the number of nodes that
 have sent the values to curr node in the previous round
}%
\@xx{}%
\@x{\@s{20.74} {\p@lbrace}\@s{352.93}}%
\@y{\@s{0}%
 ``\ensuremath{prev\_value}'' stores the previous minimum value decided by
 current node
}%
\@xx{}%
\@x{\@s{383.26}}%
\@y{\@s{0}%
 ``\ensuremath{ctr}'' is the round counter needed for the node. the rounds
 stop when \ensuremath{ctr} becomes 0
}%
\@xx{}%
 \@x{ P\@s{.5}\textrm{:}\@s{3}\@s{6.65} {\p@while} {\p@lparen} up [ self ]
 \.{\land} ctr \.{>} 0 {\p@rparen} {\p@lbrace}\@s{226.55}}%
\@y{\@s{0}%
 next round is executed when node is up and \ensuremath{ctr} is not set to 0
}%
\@xx{}%
\@pvspace{8.0pt}%
 \@x{\@s{37.14} {\p@if} {\p@lparen} pt [ self ] \.{=} 0 {\p@rparen}
 {\p@lbrace} v \.{:=} self {\p@semicolon} {\p@rbrace}
 {\p@semicolon}\@s{186.32}}%
\@y{\@s{0}%
 set the \ensuremath{v} to self for first round else the previous decision
}%
\@xx{}%
 \@x{\@s{37.14} {\p@else} {\p@lbrace} v \.{:=} d [ self ] {\p@rbrace}
 {\p@semicolon}}%
\@x{\@s{37.14} Q \.{:=} Nodes {\p@semicolon}}%
\@pvspace{8.0pt}%
...
\@x{\@s{63.33} Q \.{:=} Q \.{\,\backslash\,} \{ p \} {\p@semicolon}}%
\@x{\@s{63.33} Maybefail ( )\@s{7.16} {\p@semicolon}}%
...
\@pvspace{8.0pt}%
 \@x{ PR\@s{.5}\textrm{:}\@s{3} {\p@await} ( up [ self ] \.{=} {\TRUE}
 \.{\land} ( \A\, k \.{\in} UpNodes \.{:} pt [ self ] \.{\leq} pt [ k ] ) )
 {\p@semicolon}}%
\@x{\@s{20.74} {\p@lbrace}}%
\@x{\@s{37.14} prev\_value \.{:=} d [ self ] {\p@semicolon}}%
\@x{\@s{37.14} d [ self ] \.{:=} SetMin ( mb [ self ] ) {\p@semicolon}}%
\@pvspace{8.0pt}%
\@x{\@s{37.14}}%
\@y{\@s{0}%
...
\@x{\@s{37.14}}%
\@y{\@s{0}%
 \ensuremath{{\CASE} 1}: decision varies between first and last round
}%
\@xx{}%
\@x{\@s{37.14}}%
\@y{\@s{0}%
 \ensuremath{{\CASE} 2}: number of messages varies between current and
 previous round
}%
\@xx{}%
 \@x{\@s{37.14} {\p@if} {\p@lparen} prev\_value \.{\neq} d [ self ] \.{\lor}
 prev\_mb\_count \.{\neq} Cardinality ( mb [ self ] ) {\p@rparen} ctr \.{:=}
 1 {\p@semicolon}}%
\@x{\@s{37.14} {\p@else} ctr \.{:=} ctr \.{-} 1 {\p@semicolon}}%
\@pvspace{8.0pt}%
 \@x{\@s{37.14} prev\_mb\_count \.{:=} Cardinality ( mb [ self ] )
 {\p@semicolon}}%
\@x{\@s{37.14} mb [ self ] \.{:=} \{ \} {\p@semicolon}}%
\@pvspace{8.0pt}%
 \@x{\@s{37.14} {\p@if} {\p@lparen} ctr \.{=} 0 {\p@rparen} t [ self ] \.{:=}
 {\TRUE} {\p@semicolon}}%
\@pvspace{8.0pt}%
\@x{\@s{20.74} {\p@rbrace}}%
\@pvspace{8.0pt}%
...
\@y{\@s{0}%
 \ensuremath{end\_while
}}%
\@xx{}%
\@x{\@s{20.74} {\p@rbrace}\@s{12.29}}%
\@y{\@s{0}%
 \ensuremath{end\_process
}}%
\@xx{}%
\@x{ {\p@rbrace}}%
\@y{}%
...
\@pvspace{8.0pt}%
\@x{ {\VARIABLES} v ,\, prev\_value ,\, Q ,\, prev\_mb\_count ,\, ctr}%
\@pvspace{8.0pt}%
 \@x{ vars \.{\defeq} {\langle} failNum ,\, up ,\, pt ,\, t ,\, d ,\, mb ,\,
 pc ,\, v ,\, prev\_value ,\, Q ,\, prev\_mb\_count ,\,}%
\@x{\@s{41.61} ctr {\rangle}}%
\@pvspace{8.0pt}%
...
\@x{\@s{35.70} \.{\land} failNum \.{=} FAILNUM}%
 \@x{\@s{35.70} \.{\land} up \.{=} [ n\@s{1.93} \.{\in} Nodes \.{\mapsto}
 {\TRUE} ]}%
 \@x{\@s{35.70} \.{\land} pt\@s{1.72} \.{=} [ n\@s{1.93} \.{\in} Nodes
 \.{\mapsto} 0 ]}%
...
\@x{\@s{35.70} \.{\land} v \.{=} [ self \.{\in} Nodes \.{\mapsto} 0 ]}%
 \@x{\@s{35.70} \.{\land} prev\_value \.{=} [ self \.{\in} Nodes \.{\mapsto} 0
 ]}%
\@x{\@s{35.70} \.{\land} Q \.{=} [ self \.{\in} Nodes \.{\mapsto} \{ \} ]}%
 \@x{\@s{35.70} \.{\land} prev\_mb\_count \.{=} [ self \.{\in} Nodes
 \.{\mapsto} 0 ]}%
\@x{\@s{35.70} \.{\land} ctr \.{=} [ self \.{\in} Nodes \.{\mapsto} 1 ]}%
\@x{\@s{35.70} \.{\land} pc \.{=} [ self \.{\in} ProcSet \.{\mapsto}\@w{P} ]}%
\@pvspace{8.0pt}%
\@x{ P ( self ) \.{\defeq} \.{\land} pc [ self ] \.{=}\@w{P}}%
\@x{\@s{50.90} \.{\land} {\IF} up [ self ] \.{\land} ctr [ self ] \.{>} 0}%
...
\@x{\@s{105.48} \.{\land} {\UNCHANGED} {\langle} v ,\, Q {\rangle}}%
 ...
 ,\, d ,\, mb ,\, prev\_value ,\,}%
\@x{\@s{124.49} prev\_mb\_count ,\, ctr {\rangle}}%
\@pvspace{8.0pt}%
...
\@x{\@s{166.71} \.{\land} pt \.{'} \.{=} pt}%
 ...
 {\rangle}}%
 \@x{\@s{57.56} \.{\land} {\UNCHANGED} {\langle} t ,\, d ,\, v ,\, prev\_value
 ,\, prev\_mb\_count ,\, ctr {\rangle}}%
\@pvspace{8.0pt}%
\@x{ PR ( self ) \.{\defeq} \.{\land} pc [ self ] \.{=}\@w{PR}}%
 \@x{\@s{57.56} \.{\land} ( up [ self ] \.{=} {\TRUE} \.{\land} ( \A\, k
 \.{\in} UpNodes \.{:} pt [ self ] \.{\leq} pt [ k ] ) )}%
 \@x{\@s{57.56} \.{\land} prev\_value \.{'} \.{=} [ prev\_value {\EXCEPT}
 {\bang} [ self ] \.{=} d [ self ] ]}%
 \@x{\@s{57.56} \.{\land} d \.{'} \.{=} [ d {\EXCEPT} {\bang} [ self ] \.{=}
 SetMin ( mb [ self ] ) ]}%
 \@x{\@s{57.56} \.{\land} {\IF} prev\_value \.{'} [ self ] \.{\neq} d \.{'} [
 self ] \.{\lor} prev\_mb\_count [ self ] \.{\neq} Cardinality ( mb [ self ]
 )}%
 \@x{\@s{80.82} \.{\THEN} \.{\land} ctr \.{'} \.{=} [ ctr {\EXCEPT} {\bang} [
 self ] \.{=} 1 ]}%
 \@x{\@s{80.82} \.{\ELSE} \.{\land} ctr \.{'} \.{=} [ ctr {\EXCEPT} {\bang} [
 self ] \.{=} ctr [ self ] \.{-} 1 ]}%
 \@x{\@s{57.56} \.{\land} prev\_mb\_count \.{'} \.{=} [ prev\_mb\_count
 {\EXCEPT} {\bang} [ self ] \.{=} Cardinality ( mb [ self ] ) ]}%
 \@x{\@s{57.56} \.{\land} mb \.{'} \.{=} [ mb {\EXCEPT} {\bang} [ self ] \.{=}
 \{ \} ]}%
\@x{\@s{57.56} \.{\land} {\IF} ctr \.{'} [ self ] \.{=} 0}%
...
\vshade{5.0}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
 Name: \ensuremath{Piyush} \ensuremath{Saravagi}\@s{45.0}Name:
 \ensuremath{Abhishek} \ensuremath{Krishna
}%
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
 \ensuremath{UB} Name: piyushsu\@s{52.5}\ensuremath{UB} Name:
 \ensuremath{krishna7
}%
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
 \ensuremath{UB} \ensuremath{ID}: 50246596\@s{60.0}\ensuremath{UB}
 \ensuremath{ID}: 50246436
\end{cpar}%
\end{lcom}%
\end{document}
