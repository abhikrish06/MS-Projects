...
\@x{\@s{20.74} {\p@define} {\p@lbrace}}%
 ...
 \.{\in} S \.{:} i \.{\leq} j}%
 \@x{\@s{20.74} AllUpNodes \.{\defeq} \{ n \.{\in} Nodes \.{:} up [ n ] \.{=}
 {\TRUE} \}\@s{57.4}}%
\@y{\@s{0}%
 A set of nodes that have not failed
}%
\@xx{}%
\@x{\@s{20.74} {\p@rbrace}}%
\@pvspace{8.0pt}%
...
\@x{\@s{20.74} {\p@lbrace}}%
 ...
 {\p@rparen} {\p@lbrace}}%
\@x{\@s{31.28} v\@s{2.93} \.{:=} self {\p@semicolon}}%
\@x{\@s{31.28} Q \.{:=} Nodes {\p@semicolon}}%
...
\@x{\@s{63.33} MaybeFail ( )\@s{4.47} {\p@semicolon}}%
...
\@pvspace{8.0pt}%
 ...
 \.{\land} \A\, k \.{\in} AllUpNodes \.{:} pt [ self ] \.{=} pt [ k ] )
 {\p@semicolon}}%
\@x{\@s{37.14} d [ self ] \.{:=} SetMin ( mb [ self ] ) {\p@semicolon}}%
\@x{\@s{37.14} t [ self ]\@s{1.87} \.{:=} {\TRUE} {\p@semicolon}}%
\@pvspace{8.0pt}%
\@x{\@s{20.74} {\p@rbrace}}%
\@y{\@s{0}%
 \ensuremath{end\_if
...
\@xx{}%
 ...
 \.{:} i \.{\leq} j}%
 \@x{ AllUpNodes \.{\defeq} \{ n \.{\in} Nodes \.{:} up [ n ] \.{=} {\TRUE}
 \}}%
\@pvspace{8.0pt}%
\@x{ {\VARIABLES} v ,\, pv ,\, Q}%
\@pvspace{8.0pt}%
...
\@x{ PR ( self ) \.{\defeq} \.{\land} pc [ self ] \.{=}\@w{PR}}%
 \@x{\@s{57.56} \.{\land} ( up [ self ] \.{=} {\TRUE} \.{\land} \A\, k \.{\in}
 AllUpNodes \.{:} pt [ self ] \.{=} pt [ k ] )}%
...
Violation of Agreement property:
 The decision value, \ensuremath{d{\Box}}, is set to the minimum of
 \ensuremath{mb[self]} value.
 Now, when there is no crash node, all nodes send their value to
 \ensuremath{mb{\Box}} and minimum is selected.
 But, when one or more nodes fail, they are not able to send their value
 (which could be minimum of all values) to the mailbox of other nodes.
 Hence, when the other nodes terminate, they may not able to correctly
 determine the minimum value.
 \ensuremath{i.e} \ensuremath{min(node} \ensuremath{i)} may not be equal to
 \ensuremath{min(node} \ensuremath{j)
}%
\end{cpar}%
\vshade{5.0}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
